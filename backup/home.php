    ...
    <body>
        <div class="home-page">
            <div class="div">
                                ...
                                <div class="group">
                                    <div class="overlap-group">
                                        ...
                                        <div class="badge-primary"><div
                                                class="text-wrapper-2">2</div></div>
                                    </div>
                                </div>
                ...
                <div class="overlap">
                    <button class="label-wrapper"><div class="label-2">SHOP
                            NOW!</div></button>
                    <div class="div-wrapper">
                        <div class="frame-4"><p class="p">Connecting Farmers,
                                Feeding the Future.</p></div>
                    </div>
                </div>
                <div class="overlap-2">
                    ...
                    <button class="button-2"><div class="label-2">SHOP
                            NOW!</div></button>
                </div>
